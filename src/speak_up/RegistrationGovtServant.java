...
public class RegistrationGovtServant extends JFrame{
    ...
    public RegistrationGovtServant() 
    {
        ...
        lbl_uqu_id = new JLabel("Aadhaar Number  : ");
        lbl_sector.setForeground(c2);
        ...
        txt_uqu_id.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if(uqid.length() < 1){
                    ...
                    lbl_uqid_err.setText("Enter a valid Aadhaar");
                    add(lbl_uqid_err);
                } else {
                    remove(lbl_uqid_err);
                }
        ...
        check_re_password.addActionListener(new ActionListener() {
            @Override
