...
public class GovtProfile extends JFrame{
    ...
    public GovtProfile(){
        ...
        err_phone.setBounds(400, 135, 150, 15);
        ...
        err_city = new JLabel();
        err_city.setBounds(400, 345, 150, 15);
        err_city.setFont(err_font);
        err_city.setForeground(Color.red);
        
        
        lbl_unique_id = new JLabel("Aadhaar Number :");
    ...
    void handleDelete(){
        int option = JOptionPane.showConfirmDialog(this, "Are you sure to delete your Account? (This action cannot be undone)");
